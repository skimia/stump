...
return[
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This option controls the ability of the framework for clone files in the
    | public dir of determine files to copy
    |
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Copy mode of required assets
    |--------------------------------------------------------------------------
    |
    | This option controls the copy mode of packages assets for make it
    | accesible from public dir.
    |
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Autoregenerate & Copy assets collections on local env
    |--------------------------------------------------------------------------
